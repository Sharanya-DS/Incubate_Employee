 ...
 * construct JPA queries for any Incubatesoft related flow. The queries are self
 ...
 */
@Repository
public interface IncubateRepository extends JpaRepository<Incubatesoft, Integer> {

	Incubatesoft findByIncubateId(int incubateId);
